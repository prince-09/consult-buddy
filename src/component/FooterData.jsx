...
export const footerInfo = [
    {icon: faBuffer, info1: 'Consult Buddy', id: 1},
    {icon: faMobileAlt, info1: '+919065967814', info2: 'princesinha7072@gmail.com', id: 2},
    {icon: faMapMarkedAlt, info1: 'Patna', info2: 'Bihar, India', id: 3}
];